        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
            ...
            <div class="flex flex-wrap gap-3 items-center w-full md:w-auto">
                ...
                <div class="flex flex-col">
                    ...
                    <select id="category"
                        class="p-2 border border-gray-300 rounded-md bg-white text-gray-700 text-xs w-32 focus:outline-none focus:ring-1 focus:ring-green-500">
                ...
                <div class="flex flex-col">
                    ...
                    <select id="month"
                        class="p-2 border border-gray-300 rounded-md bg-white text-gray-700 text-xs w-28 focus:outline-none focus:ring-1 focus:ring-green-500">
                ...
                <div class="flex flex-col">
                    ...
                    <select id="year"
                        class="p-2 border border-gray-300 rounded-md bg-white text-gray-700 text-xs w-20 focus:outline-none focus:ring-1 focus:ring-green-500">
