<aside
    class="fixed inset-y-0 left-0 z-40 w-64 text-white shadow-xl transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out bg-gradient-to-b from-red-600 to-red-800"
    id="sidebar">
