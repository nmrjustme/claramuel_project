            ...
            <div class="glass-card bg-white p-6 hover-scale rounded-lg shadow-sm">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="relative w-full md:w-64">
                            ...
                            <input id="search-input" type="text"
                                class="block w-full pl-10 pr-3 py-2 border border-darkgray rounded-lg leading-5 bg-white/50 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 sm:text-sm"
                ...
                <div class="flex flex-col sm:flex-row justify-between items-center mt-6 gap-4">
                    ...
                    <div class="flex gap-2">
                        <button id="prev-page"
                            class="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg font-medium hover:bg-gray-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                            disabled>
                        ...
                        {{-- <button id="generate-excel"
                            class="bg-green-600 text-white rounded-lg font-medium hover:from-green-700 hover:to-green-800 transition-colors flex items-center gap-2 shadow-md hover:shadow-lg px-4 py-2 ">
                    ...
                    <div class="bg-gradient-to-r from-red-50 to-red-100 p-4 rounded-lg border border-red-100">
                        ...
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-red-500 mr-2"
                                viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd"
                                    d="M9 2a1 1 0 00-1 1v1H5a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2V6a2 2 0 00-2-2h-3V3a1 1 0 00-1-1H9zm-1 7.707l2 2 4-4a1 1 0 00-1.414-1.414L10 9.586 8.707 8.293a1 1 0 00-1.414 1.414z"
                                    clip-rule="evenodd" />
                            </svg>
                ...
                <div class="glass-card bg-white overflow-hidden hover-scale rounded-lg shadow-sm">
                    ...
                    <div class="p-0 fade-in" id="booking-summary">
                        <div class="text-center py-10 px-4 text-gray-400">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 mx-auto mb-4 text-gray-300"
