<div class="space-y-6">
                ...
                <div class="flex justify-between">  
                    ...
                    <dd class="text-sm">
                        @if($payment->status == 'N/A')
                            <span class="px-2 py-1 rounded-full bg-gray-600 text-white">N/A</span>
                        ...
                        @elseif($payment->status == 'under_verification')
                            <span class="px-2 py-1 rounded-full bg-blue-600 text-white">Under Verification</span>
        ...
        <div class="bg-gray-50 p-4 rounded-lg">
            ...
            <dl class="mt-2 space-y-2">
                ...
                <div class="flex justify-between">
                    ...
                    <dd class="text-sm text-gray-900">{{ $payment->bookingLog->user->phone ?? 'N/A' }}</dd>
                </div>
            </dl>
        </div>
    </div>
    ...
    <div class="bg-white p-4 rounded-lg border border-gray-200">
        ...
        <div class="mt-2 flex justify-center">
            ...
            <div class="relative group transition-all duration-300">
                <img src="{{ url($payment->receipt_path) }}" 
                     alt="Payment receipt"
        ...
        <div class="flex items-center">
            ...
            <div class="ml-3">
                ...
                <div class="mt-1 text-sm text-green-700">
                    <p>Verified by: {{ $payment->bookingLog->user->firstname ?? 'System Admin' }}</p>
        ...
        <div class="flex">
            ...
            <div class="ml-3">
                ...
                <div class="mt-1 text-sm text-red-700">
                    <p><span class="font-medium">Reason:</span> {{ $payment->rejection_reason }}</p>
                    @if(strpos($payment->rejection_reason, 'GCash reference mismatch') !== false)
                        <p class="mt-1">The GCash reference number provided did not match our records.</p>
                    @endif
                </div>
            </div>
        </div>
    ...
    <div class="mt-6 flex justify-end space-x-3" id="actionButtons">
        <button type="button" onclick="confirmVerifyPaymentButton()" class="px-4 py-2 bg-green-600 text-white rounded-md text-sm font-medium hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
        ...
        <button type="button" onclick="showRejectForm()" class="px-4 py-2 bg-red-600 text-white rounded-md text-sm font-medium hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 inline mr-1" viewBox="0 0 20 20" fill="currentColor">
