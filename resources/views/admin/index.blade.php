...
<div class="min-h-screen p-6">
            ...
            <div class="relative z-10">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        @auth
                            <p class="opacity-90 mt-2">Welcome back, {{ auth()->user()->firstname }}! Here's what's happening today.</p>
                        @endauth
                    </div>
                ...
                <div class="mt-6 flex items-center space-x-2">
                    <span class="px-3 py-1 bg-white/20 rounded-full text-sm font-medium">@php echo \Carbon\Carbon::now('Asia/Manila')->format('l, F j, Y'); @endphp</span>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        <!-- Recent Enquiries -->
        <div class="h-card h-card--no-header h-py-8 h-mb-24 h-mr-8 bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover-scale">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover-scale">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-start p-3 bg-blue-50 rounded-lg group hover:bg-blue-100 transition-colors">
                    <div class="flex-shrink-0 h-12 w-12 bg-blue-100 rounded-full flex items-center justify-center mr-3 group-hover:bg-blue-200 transition-colors">
                ...
                <div class="flex items-start p-3 bg-green-50 rounded-lg group hover:bg-green-100 transition-colors">
                    <div class="flex-shrink-0 h-12 w-12 bg-green-100 rounded-full flex items-center justify-center mr-3 group-hover:bg-green-200 transition-colors">
                        <span class="text-green-800 font-medium">AS</span>
                    </div>
                    <div class="flex-1">
                        <div class="flex justify-between items-baseline">
                            <h4 class="text-sm font-medium text-gray-900">Alice Smith</h4>
                            <span class="text-xs text-green-600 bg-green-100 px-2 py-1 rounded-full">3:00 PM</span>
                        </div>
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover-scale">
            ...
            <div class="grid grid-cols-2 gap-4">
                <a href="#" id="openBookingModal" class="p-4 bg-red-50 rounded-lg text-center hover:bg-red-100 transition-colors group hover-scale">
                ...
                <a href="#" onclick="openCheckInModal()" class="p-4 bg-blue-50 rounded-lg text-center hover:bg-blue-100 transition-colors group hover-scale">
                ...
                <a href="#" class="p-4 bg-green-50 rounded-lg text-center hover:bg-green-100 transition-colors group hover-scale">
                ...
                <a href="#" class="p-4 bg-purple-50 rounded-lg text-center hover:bg-purple-100 transition-colors group hover-scale">
...
<div id="checkInModal" class="fixed inset-0 bg-gray-600/50 backdrop-blur-sm flex items-center justify-center hidden z-50">
    <div class="bg-white rounded-xl shadow-xl overflow-hidden w-full max-w-md mx-4 transform transition-all duration-300 scale-95 hover:scale-100">
        ...
        <div class="p-6 space-y-4">
            ...
            <a href="{{ route('checkin.scanner') }}" class="block group">
                <div class="p-4 bg-red-50 rounded-lg border border-red-100 hover:border-red-300 transition-all duration-200 flex items-start hover-scale">
            ...
            <div class="border border-red-100 rounded-lg overflow-hidden hover:border-red-300 transition-colors duration-200 hover-scale">
            ...
            <button onclick="showManualSearch()" class="w-full p-4 bg-gray-50 rounded-lg border border-gray-200 hover:border-gray-300 transition-all duration-200 flex items-start hover-scale">
