                  ...
                  <div class="md:w-2/3">
                        <div class="rounded-xl border border-gray-200 overflow-hidden relative print-border">
                              ...
                              <div class="header-gradient text-white p-6 text-center relative">
                                    ...
                                    <p class="text-primary-100 opacity-90 text-sm">Reservation Code: {{
                                          ...
                                          <div class="flex items-center mb-4">
                                                <div class="bg-primary-100 p-2 rounded-full mr-3">
                                                      <svg xmlns="http://www.w3.org/2000/svg"
                                                            class="h-5 w-5 text-primary-600" viewBox="0 0 20 20"
                                                            fill="currentColor">
                                                            <path fill-rule="evenodd"
                                    ...
                                    <div class="mb-8">
                                          <div class="flex items-center mb-4">
                                                <div class="bg-primary-100 p-2 rounded-full mr-3">
                                                      <svg xmlns="http://www.w3.org/2000/svg"
                                                            ...
                                                            fill="currentColor">
                                                            <path fill-rule="evenodd"
                                                                  d="M4 4a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm3 2a1 1 0 000 2h.01a1 1 0 100-2H7zm3 0a1 1 0 000 2h3a1 1 0 100-2h-3zm-3 4a1 1 0 100 2h.01a1 1 0 100-2H7zm3 0a1 1 0 100 2h3a1 1 0 100-2h-3z"
                                                                  clip-rule="evenodd" />
                                                      </svg>
                                                </div>
                                          ...
                                          <div class="highlight-box p-4 rounded-lg mb-4 print:border-0 print:p-0">
                                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 print:block">
                                                      ...
                                                      <div class="print-row">
                                                            ...
                                                            <span class="font-medium text-gray-800 print-value">₱{{
                                                                  number_format($summary->breakfast->price * $nights)
                                                                  }}/morning(s)</span>
                                                      </div>
                                                      @endif
                                                      ...
                                                      <div class="md:col-span-2 pt-2 print:block print-row">
                                                            ...
                                                            <span class="font-medium text-primary-600 print-value">₱{{
                                          ...
                                          <div
                                                ...
                                                <span class="text-lg font-bold text-gray-700 print-label">Total
                                                      Amount:</span>
                                                <span class="text-xl font-bold text-primary-600 print-value">₱{{
                                          ...
                                          <div class="space-y-3">
                                                ...
                                                <div class="payment-row">
                                                      ...
                                                      <span class="payment-value text-green-600">₱{{
                                                            number_format($payment->amount_paid, 2) }}</span>
                                                </div>
                                                ...
                                                <div class="payment-row">
                                                      ...
                                                      <span class="payment-value text-green-600">₱{{
                                                            number_format($payment->checkin_paid, 2) }}</span>
                                                </div>
                                                @endif

                                                @php
                                                $remainingBalance = $totalAmount - $payment->amount_paid - $payment->checkin_paid;
                                                @endphp
                                                ...
                                                <div
                                                      ...
                                                      <span
                                                            class="payment-label text-lg font-semibold text-gray-700 flex items-center">
                                                            Balance Amount
                                                      </span>
                                                      <span class="payment-value text-2xl font-extrabold {{ $remainingBalance > 0 ? 'text-red-600' : 'text-green-600' }}">
                                    ...
                                    <div class="mb-6">
                                          ...
                                          <div class="flex items-center justify-between mb-3 print-row">
                                                ...
                                                <span id="status-display"
                                                      ...
                                                      @elseif($payment->remaining_balance_status === 'pending')
                                          ...
                                          <div class="no-print">
                                                <label for="status-select"
                                                      class="block text-sm font-medium text-gray-700 mb-1">Change
                                                      Status</label>
                                                <div class="flex flex-col gap-4">
                                                      <div class="flex gap-2">
                                                            <select id="status-select"
                                                                  class="block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 py-2 px-3 border text-sm">
                                                                  <option value="pending" {{ $payment->
                                                                        remaining_balance_status === 'pending' ?
                                                                        'selected' : '' }}>Pending</option>
                                                                  <option value="fully_paid" {{ $payment->
                                                                        remaining_balance_status === 'fully_paid' ?
                                                                        'selected' : '' }}>Fully Paid</option>
                                                            </select>
                                                            <button id="save-btn"
                                                                  class="bg-blue-600 hover:bg-blue-500 text-white font-medium py-2 px-4 rounded-md transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed text-sm">
                                                                  Save
                                                            </button>
                                                      </div>
                                                      ...
                                                      <div id="amount-container" class="hidden">
                                                            ...
                                                            <div class="relative rounded-md shadow-sm">
                                                                  ...
                                                                  <input type="number" id="paid-amount"
                                                                    class="focus:ring-primary-500 focus:border-primary-500 block w-full pl-7 pr-12 sm:text-sm border-gray-300 rounded-md py-2"
                                                                    placeholder="0.00" step="0.01" min="0" max="{{ $remainingBalance }}" 
                                                                    value="{{ $remainingBalance }}" required>
                                                                  <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                                                    <span class="text-gray-500 sm:text-sm">max: {{ number_format($remainingBalance, 2) }}</span>
                                                                  </div>
                                                            </div>
                                                      </div>
                                                </div>
                                          ...
                                          <div class="bg-green-50 p-4 rounded-lg border border-green-200">
                                                <div class="flex items-center">
                                                      ...
                                                      <p class="text-green-800 font-medium">All payments have been settled. No balance remaining.</p>
                                                </div>
                                          </div>
                                          @endif
                                    </div>
      ...
      <script>
            document.addEventListener('DOMContentLoaded', function () {
                  ...
                  yesBtn.addEventListener('click', function () {
                        ...
                        showToast('Checked-out booking status recorded!', 'success');
                  });
                  ...
                  function updateBookingStatus() {
                        ...
                        fetch(`/update/booking/checkout/status/${paymentId}`, {
                              method: 'POST',
                              headers: {
                  ...
                  // Only initialize if elements exist (if there's a balance)
                  if (statusSelect && amountContainer && saveBtn) {
                        ...
                        saveBtn.addEventListener('click', function () {
                              ...
                              if (newStatus === 'fully_paid') {
                                    ...
                                    // Validate that paid amount doesn't exceed remaining balance
                                    const remainingBalance = parseFloat({{ $totalAmount - $payment->amount_paid - $payment->checkin_paid }});
                                    if (paidAmount > remainingBalance) {
                                          showToast(`Amount paid (₱${paidAmount.toFixed(2)}) exceeds remaining balance (₱${remainingBalance.toFixed(2)})`, 'error');
                                          return;
                                    }
                              }
