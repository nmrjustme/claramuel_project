        ...
        <div class="mb-6">
            ...
            @if(session('success'))
                <div id="flash-message"
                    class="mt-4 p-4 rounded-lg bg-green-100 text-green-800 font-medium shadow-md transition transform duration-500">
                    {{ session('success') }}
                </div>
            @endif
            ...
            @if(session('error'))
                <div id="flash-message"
                    class="mt-4 p-4 rounded-lg bg-red-100 text-red-800 font-medium shadow-md transition transform duration-500">
                    {{ session('error') }}
                </div>
            @endif
            ...
            <form method="POST" action="{{ route('admin.daytour.store') }}" class="space-y-8" id="dayTourForm">
                ...
                <div class="bg-white rounded-2xl border border-gray-200 shadow-lg p-6">
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div class="relative">
                            ...
                            <!-- Custom Date Picker -->
                            <div id="datePicker"
                                class="hidden absolute z-50 bg-white rounded-2xl border border-gray-200 shadow-xl p-6 mt-2 w-full max-w-md">
                                <div class="flex justify-between items-center mb-6">
                                    <h4 class="text-lg font-semibold text-gray-800" id="currentMonth"></h4>
                                    <div class="flex space-x-2">
                                        <button type="button" data-action="prev-month"
                                            class="p-2 rounded-xl bg-gray-50 border border-gray-200 hover:bg-gray-100 transition-colors shadow-sm">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="service-option" data-value="pool">
                                <input type="radio" id="servicePool" name="service_type" value="pool" class="hidden"
                                    checked>
                                <label for="servicePool"
                                    class="flex flex-col items-center p-6 border-2 border-gray-100 rounded-2xl cursor-pointer hover:border-blue-300 hover:shadow-lg transition-all duration-200 service-label">
                            ...
                            <div class="service-option" data-value="themed_park">
                                ...
                                <label for="servicePark"
                                    class="flex flex-col items-center p-6 border-2 border-gray-100 rounded-2xl cursor-pointer hover:border-green-300 hover:shadow-lg transition-all duration-200 service-label">
                            ...
                            <div class="service-option" data-value="both">
                                ...
                                <label for="serviceBoth"
                                    class="flex flex-col items-center p-6 border-2 border-gray-100 rounded-2xl cursor-pointer hover:border-purple-600 hover:shadow-lg transition-all duration-200 service-label">
                ...
                <div id="accommodationSection" class="bg-white rounded-2xl border border-gray-200 shadow-lg p-6">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div id="accommodationValidation"
                            class="hidden flex items-center space-x-2 px-3 py-2 bg-red-50 border border-red-200 rounded-lg">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            @foreach($cottages as $cottage)
                                <div
                                    class="accommodation-item flex items-center justify-between p-5 bg-gray-50 border border-gray-100 rounded-xl shadow-sm hover:shadow-md transition-all duration-200">
                                        ...
                                        <div class="price-display" data-id="{{ $cottage->id }}">
                                            @if($cottage->has_discount)
                                                <div class="flex items-center space-x-2">
                                                    <span
                                                        class="text-sm text-gray-400 line-through">₱{{ number_format($cottage->original_price, 2) }}</span>
                                                    <span
                                                        class="text-sm text-green-600 font-semibold">₱{{ number_format($cottage->price, 2) }}</span>
                                    ...
                                    <input type="number" name="accommodations[{{ $cottage->id }}]" min="0" value="0"
                                        data-original-price="{{ $cottage->original_price }}" data-price="{{ $cottage->price }}"
                            ...
                            @foreach($villas as $villa)
                                <div
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <div class="price-display" data-id="{{ $villa->id }}">
                                            @if($villa->has_discount)
                                                <div class="flex items-center space-x-2">
                                                    <span
                                                        class="text-sm text-gray-400 line-through">₱{{ number_format($villa->original_price, 2) }}</span>
                                                    <span
                                                        class="text-sm text-green-600 font-semibold">₱{{ number_format($villa->price, 2) }}</span>
                                                    <span class="text-xs bg-green-100 text-green-800 px-2 py-1 rounded-full">
                                    ...
                                    <input type="number" name="accommodations[{{ $villa->id }}]" min="0" value="0"
                                        data-original-price="{{ $villa->original_price }}" data-price="{{ $villa->price }}"
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center space-x-4">
                            <label class="flex items-center space-x-2 cursor-pointer">
                                <input type="checkbox" id="applyManualDiscount"
                        ...
                        <div id="manualDiscountFields" class="hidden space-y-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label for="discountType" class="block text-sm font-medium text-gray-700 mb-2">Discount
                                        Type</label>
                                ...
                                <div>
                                    <label for="discountValue" class="block text-sm font-medium text-gray-700 mb-2">Discount
                                        Value</label>
                            ...
                            <div>
                                <label for="discountReason" class="block text-sm font-medium text-gray-700 mb-2">Reason for
                                    Discount</label>
                ...
                <div class="flex justify-end">
                    <button type="submit"
                        class="px-8 py-4 bg-red-500 hover:bg-red-600 text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center transform hover:scale-105">
