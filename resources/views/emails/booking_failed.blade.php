...
<head>
    ...
    <style>
        ...
        .custom-message {
            background: #fdeaea; /* soft red/pink background */
            border: 1px solid #f5c2c7;
            border-left: 6px solid #d93025; /* Google red accent */
            padding: 25px;
            border-radius: 8px;
            margin: 20px 0;
            color: #7a1c1c; /* dark red text */
            position: relative;
            overflow: hidden;
        }
...
<body>
    <div class="container">
        <div class="custom-message">
            ...
            <p>If you believe the payment went through but still received this message, please contact us immediately so we can verify your transaction.</p>
