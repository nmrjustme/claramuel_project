    ...
    <div class="container mx-auto px-6 py-8 max-w-12xl">
        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="lg:w-2/3 space-y-6">
                ...
                <div class="rounded-xl mb-8 p-8 border border-gray-200 bg-white shadow-sm">
                    ...
                    <div class="bg-blue-50 rounded-lg p-5 mb-6 border border-blue-100">
                        <div class="flex items-center mb-3">
                            ...
                            <h4 class="text-base font-semibold text-blue-700">E-Wallets</h4>
                        </div>
                        <p class="text-sm text-gray-600 mb-4">Maya, GCash, QR Ph, or any supported e-wallet</p>
                    ...
                    <div class="bg-purple-50 rounded-lg p-5 mb-6 border border-purple-100">
                        <div class="flex items-center mb-3">
                            ...
                            <h4 class="text-base font-semibold text-purple-700">Debit / Credit Cards</h4>
                        </div>
                        <div class="flex flex-wrap justify-center gap-5">
                            <div class="bg-white p-3 rounded-lg shadow-sm border border-gray-100">
                    ...
                    <div class="bg-green-50 rounded-lg p-5 border border-green-100">
                        <div class="flex items-center mb-3">
                            ...
                            <h4 class="text-base font-semibold text-green-700">Cash</h4>
                        </div>
                        <div class="flex justify-center">
                            <span
                                class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-green-500 to-green-600 text-white text-sm font-semibold rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200">
                                Cash Payment
                            </span>
                        </div>
                    </div>
