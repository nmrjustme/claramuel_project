...
<style>
     ...
     .room-card {
          ...
          border-radius: 1rem;
          overflow: visible;
          /* IMPORTANT: let calendar grow out inside */
          background: white;
                                                       ...
                                                       <div class="mt-auto pt-3">
                                                            <div
                                                                 ...
                                                                 <div class="price-details flex-grow min-h-[60px]">
                                                                      ...
                                                                      @if($activeDiscount)
                                                                      <div
                                                                           class="text-xs xs:text-sm text-green-600 font-medium mb-1">
                                                                           <i class="fas fa-tag mr-1"></i>
                                                                           @if($activeDiscount->discount_type ===
                                                                           'percent')
                                                                      ...
                                                                      <div class="flex items-center flex-wrap gap-x-2">
                                                                           ...
                                                                           <div
                                                                                ...
                                                                                'percent'
                                                                                ? ($facility->price *
                                                                                $activeDiscount->discount_value / 100)
